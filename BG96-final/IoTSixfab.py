...
from Adafruit_ADS1x15 import ADS1015    # readAdc(channelNumber)
from SDL_Pi_HDC1000 import * # reading temperature     # for BG96
from MMA8452Q import MMA8452Q # read the accelerometer     # for BG96
...
class IoT():
    ...
    def __init__(self):
        self.board = "Sixfab Raspberry Pi Cellular IoT Application Shield"        ##### maha maha why self. and no self.
        ser.port = "/dev/ttyS0"
        ser.baudrate = 115200
